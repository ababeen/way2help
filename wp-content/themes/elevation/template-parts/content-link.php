...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post-content media-body">
        ...
        <?php 
        $link_text = candor_framework_meta( '_elevation_link_text' );
        $link = candor_framework_meta( '_elevation_link' );
        if( $link_text ) { ?>
            <div class="post-thumbnail">
                <div  class="attachmentlink">
                    <a class="attach-link" href="<?php echo $link; ?>" > <?php echo  $link_text; ?></a>
                </div><!-- /.attachmentlink -->
            </div><!-- /.post-thumbnail -->
        <?php } ?>
