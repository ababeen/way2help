...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post-date media-left">
		<time datetime="<?php the_time();?>"><span class="date media-left"><?php echo $newdate['day']; ?></span> <span class="media-body"><?php echo $dt->format('M'); ?> <?php echo $newdate['year']; ?></span></time>
	</div><!-- /.post-date -->
	...
	<div class="post-content media-body">
		...
		<div class="event-details">
			<div class="event-date">
				<?php echo esc_html__("Event Date:", "elevation");?> <span> <?php echo $event_date;?></span>
			</div>  					
			<div class="event-place">
				<?php echo esc_html__("Event Place:", "elevation");?> <span> <?php echo $event_place;?></span>
			</div>  					
			<div class="event-start">
				<?php echo esc_html__("Event Start:", "elevation");?> <span> <?php echo $event_start;?></span>
			</div>  					
			<div class="event-end">
				<?php echo esc_html__("Event End:", "elevation");?> <span> <?php echo $event_end;?></span>
			</div>
		</div>
