...
if(!( function_exists('elevation_admin_load_scripts') )){
	function elevation_admin_load_scripts(){
		wp_enqueue_style( 'ebor-theme-admin-css', ELEVATION_THEME_DIRECTORY . 'inc/candor-theme-admin.css' );
	}
...
if(!function_exists('elevation_admin_logo_login')){
	...
	if( !function_exists('elevation_cause_donation_button') ){
		function elevation_cause_donation_button($cause_option = array()){
			...
			if( !empty($donation_form) && strpos($donation_form, 'http') === 0 ){
				$button  = '<div class="btn-container"><a class="btn btn-xsm donate-btn" ';
				$button .= 'href="' . $donation_form . '">';
				$button .= esc_html__('Donate Now', 'elevation') . '</a></div>';	
			}else if( !empty($donation_form) ){
				$button  = '<div class="btn-container"><a class="btn btn-xsm donate-btn" data-rel="fancybox" ';
				$button .= 'href="#donate-button-' . $elevation_donation_id . '">';
				$button .= esc_html__('Donate Now', 'elevation') . '</a></div>';
	...
	if( !function_exists('elevation_pdf_download') ){
		function elevation_pdf_download(){ ?>
		    ...
		    ?>
		      	<a class="cause-info cause-pdf" href="<?php echo $pdf_file; ?>"><?php echo esc_html__('Download PDF','elevation'); ?></a>
      ...
      <div class="section-padding">
        <div class="container">
          <div class="section-top">
            <h2 class="page-title">
            	<?php if (isset($elevation_options['blog_title'])) echo $elevation_options['blog_title']; ?>
            </h2><!-- /.page-title -->
            <p class="page-description">
              <?php if (isset($elevation_options['blog_subtitle'])) echo $elevation_options['blog_subtitle']; ?>
            </p><!-- /.page-description -->
          </div><!-- /.section-top -->
                ...
                <div class="banner-text">
                  <div class="section-top">
                    <h3 class="error-title">
                      <?php if (isset($elevation_options['settings_404_title'])) echo $elevation_options['settings_404_title']; ?>
                    </h3><!-- /.error-title -->
                  </div><!-- /.section-top -->
                  ...
                  <h1 class="error-main-title">
                    <?php if (isset($elevation_options['settings_404_heading'])) echo $elevation_options['settings_404_heading']; ?>
                  </h1><!-- /.main-title -->
                  <h2 class="error-sub-title">
                    <?php if (isset($elevation_options['settings_404_subheading'])) echo $elevation_options['settings_404_subheading']; ?>
                  </h2><!-- /.sub-title -->
                  <div class="btn-container">
                    <a href="<?php echo esc_url( home_url( '/' ));?>" class="btn btn-lg">
                    	<?php if (isset($elevation_options['settings_404_return_home'])) echo $elevation_options['settings_404_return_home']; ?>
                    </a>
                  </div><!-- /.btn-container -->
                </div><!-- /.banner-text -->
              </div><!-- /.container -->
	...
	?>
		<div class="section-top">
			<h2 class="landing-title">
				<?php if (isset($coming_soon_title)) echo $coming_soon_title; ?>
			</h2><!-- /.landing-title -->
			<p class="section-description">
				<?php if (isset($coming_soon_sub_title)) echo $coming_soon_sub_title; ?>
...
function elevation_import_files() {
    return array(
        ...
        array(
            ...
            'import_customizer_file_url' => ELEVATION_PATH . '/inc/demo-importer/contents/customizer.dat',
            'import_redux'               => array(
                array(
            ...
            'import_notice'              => __( 'After you import this demo, you will have to setup the slider separately.', 'elevation' ),
        ),

        array(
            'import_file_name'           => 'Homepage 2',
            'categories'                 => array( 'Home Variations' ),
            'import_file_url'            => ELEVATION_PATH . '/inc/demo-importer/contents/demo-content.xml',
            'import_widget_file_url'     => ELEVATION_PATH . '/inc/demo-importer/contents/widgets.json',
            'import_customizer_file_url' => ELEVATION_PATH . '/inc/demo-importer/contents/customizer.dat',
...
function elevation_after_import_setup() {
	...
	// Example of Menus to assign after import.
