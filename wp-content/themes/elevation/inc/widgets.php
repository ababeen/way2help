...
if(!( class_exists('elevation_about_us_widget') )){
	class elevation_about_us_widget extends WP_Widget {
		...
		function form($instance)
		{
			...
			<p>
				<label for="<?php echo $this->get_field_id('title'); ?>"><?php echo esc_html__( 'Title:', 'elevation' ); ?></label>
				<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" value="<?php echo $instance['title']; ?>" />
			</p>
			<p>
				<label for="<?php echo $this->get_field_id('description'); ?>"><?php echo esc_html__( 'Description:', 'elevation' ); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('address'); ?>"><?php echo esc_html__( 'Address:', 'elevation' ); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('phone'); ?>"><?php echo esc_html__( 'Phone:', 'elevation' ); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('email'); ?>"><?php echo esc_html__( 'Email:', 'elevation' ); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('website'); ?>"><?php echo esc_html__( 'Website:', 'elevation' ); ?></label>
