...
?>
  <style type="text/css">
          ...
          .navbar-default .navbar-nav li a{
            color: <?php echo $elevation_options['navbar_text_color']; ?> !important;
          }
          .navbar-default .navbar-nav>.active>a, .navbar-default .navbar-nav>.open>a, .navbar-default .navbar-nav>.active>a, .navbar-default .navbar-nav>.active>a:focus, .navbar-  default .navbar-nav>.active>a:hover, .navbar-default .navbar-nav>li>a:focus, .navbar-default .navbar-nav>li>a:hover, .events-slider .event-item time, .entry-title a:hover, .designation a, .widget-contact li:before, .post-meta a, .entry-footer .edit-link a, .post-tag a, .logged-in-as a:last-child{
            color: <?php echo $elevation_options['navbar_link_hover_color']; ?> !important;
          }
          .navbar-default .navbar-nav li a:hover{
            color: <?php echo $elevation_options['navbar_link_hover_color']; ?> !important;
          }
          .navbar-nav li .sub-menu>li>a{
            background: <?php echo $elevation_options['navbar_dropdown_bg_color']; ?> !important;
            color: <?php echo $elevation_options['navbar_dropdown_text_color']; ?> !important;
          }          
          .navbar-nav li .sub-menu>li>a:hover{
            color: <?php echo $elevation_options['navbar_dropdown_hover_color']; ?> !important;
          }
        ...
        .navbar-default .navbar-brand>img{
          width: <?php echo $elevation_options['logo_width']; ?>px !important;
          height: <?php echo $elevation_options['logo_height']; ?>px !important;
        }
