...
function elevation_scripts() {
	...
	global $elevation_options;
  	...
  	$google_maps_key = $elevation_options['google_maps_api_key'];
	...
	if(!is_admin()){
		...
		if ( is_page() && is_front_page() && is_home() ) {
				...
				if( $elevation_options[ 'enable_fancybox']){ 
...
/**
* Theme Functions of Elevation Theme
*/
...
function elevation_register_required_plugins() {
    ...
    $plugins = array(
    	...
    	array(
    			...
    			'slug'     			 => esc_html__( 'candor-framework', 'elevation' ),
    			'source'   			 => esc_url_raw( 'https://github.com/jeweltheme/candor-framework/archive/master.zip','elevation' ),
    			'required' 			 => true,
    			'version'            => '1.2.5'
    		),	
    	array(
	    		'name'     			 => esc_html__( 'Visual Composer', 'elevation' ),
	    		'slug'     			 => esc_html__( 'js_composer', 'elevation' ),
    	...
    	array(
    			...
    			'slug'     			 => esc_html__( 'revslider', 'elevation' ),
    			'source'   			 => esc_url_raw( 'http://demos.jeweltheme.com/plugin-downloads/revslider.zip','elevation' ),
    			'required' 			 => true,
    			'version'            => '5.4'
    		),	    	
    	array(
    		 	'name'     			 => esc_html__( 'Envato WordPress Toolkit', 'elevation' ),
    			'slug'     			 => esc_html__( 'envato-wordpress-toolkit', 'elevation' ),
    			'source'   			 => esc_url_raw( 'https://github.com/envato/envato-wordpress-toolkit/archive/master.zip','elevation' ),
    			'required' 			 => true,
    			'version'            => ''
    		),	
        array(
	        	'name'      		 => esc_html__( 'Contact Form 7', 'elevation' ),
	        	'slug'      		 => esc_html__( 'contact-form-7', 'elevation' ),
	        	'required'  		 => true,
	        	'force_activation'   => false,
	        ),             
        array(
	        	'name'      		 => esc_html__( 'Redux Framework', 'elevation' ),
	        	'slug'      		 => esc_html__( 'redux-framework', 'elevation' ),
	        	'required'  		 => true,
	        	'force_activation'   => false,
	        ),           
        array(
	        	'name'      		 => esc_html__( 'MailChimp for WordPress', 'elevation' ),
	        	'slug'      		 => esc_html__( 'mailchimp-for-wp', 'elevation' ),
	        	'required'  		 => true,
	        	'force_activation'   => false,
	        ),           
     ...
     */
    $config = array(
        'domain'            => 'elevation',           // Text domain - likely want to be the same as your theme.
...
add_shortcode('wpml_translate', 'elevation_wpml_translate_shortcode');	
if( !function_exists('elevation_wpml_translate_shortcode') ){
	function elevation_wpml_translate_shortcode( $atts, $content = null ) {
